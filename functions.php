<?php
/**
 * bay-helsinki functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package bay-helsinki
 */
...
if ( ! function_exists( 'bayhelsinki_setup' ) ) :
	...
	function bayhelsinki_setup() {
		 ...
		 * If you're building a theme based on bay-helsinki, use a find and replace
...
function bayhelsinki_scripts() {
	...
	wp_enqueue_style( 'bayhelsinki-components', get_template_directory_uri() . '/dist/components.css' );
